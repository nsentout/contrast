...
fonction discard d’OpenGL dans le fragment shader diminue les performances pour la plupart des hardwares[1]).
...
\subsection{Implémentation des marques de type texte}
