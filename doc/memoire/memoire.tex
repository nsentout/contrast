...
Le shader program est un programme écris en GLSL qui est exécuté sur le GPU. Il est découpé en plusieurs passes, voici les trois essentiel dans l'ordre d'execution :
\begin{itemize}
